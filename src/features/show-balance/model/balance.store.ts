...
export class BalanceStore {
  ...
  constructor(private _data: { tokenSymbol: TOKEN_SYMBOLS, signer: JsonRpcSigner}) {
    makeAutoObservable(this)

    this._contract = new Contract(TOKEN_ADDRESS[_data.tokenSymbol], TOKEN_ABI[_data.tokenSymbol], _data.signer)
